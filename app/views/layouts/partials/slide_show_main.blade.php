<div class="homepage-slider">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div id="rev_slider_3_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="home-05"
                    data-source="gallery"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-7" data-transition="random-premium" data-slotamount="default"
                                ...
                                <div class="tp-caption     rev_group" id="slide-7-layer-1"
                                    ...
                                    data-width="['818','818','630','428']" data-height="['380','380','342','272']"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-7-layer-2"
                                        ...
                                        data-fontsize="['24','24','20','20']" data-width="none" data-height="none"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-7-layer-3"
                                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                        data-y="['top','top','top','top']" data-voffset="['30','30','29','34']"
                                        data-fontsize="['199','199','150','100']"
                                        data-lineheight="['200','200','150','100']" data-width="none" data-height="none"
                                        data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-7-layer-4"
                                        data-x="['center','center','center','center']"
                                        data-hoffset="['0','0','-1','-1']" data-y="['top','top','top','top']"
                                        data-voffset="['254','254','188','149']" data-fontsize="['24','24','20','16']"
                                        data-lineheight="['30','30','24','20']"
                                        data-letterspacing="['10','10','5','4']" data-width="none" data-height="none"
                                        data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                    ...
                                    <a class="tp-caption LA_White_btn rev-btn " href="shop-sidebar.html"
                                        ...
                                        data-voffset="['311','311','259','208']" data-fontsize="['14','14','14','12']"
                            ...
                            <li data-index="rs-8" data-transition="random-premium" data-slotamount="default"
                                ...
                                <div class="tp-caption     rev_group" id="slide-8-layer-1"
                                    ...
                                    data-width="['867','867','654','442']" data-height="['379','379','288','226']"
                                    data-whitespace="nowrap" data-type="group" data-responsive_offset="on"
                                    data-frames='[{"delay":10,"speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                    data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                                    data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-8-layer-3"
                                        ...
                                        data-voffset="['45','45','42','42']" data-fontsize="['199','199','150','100']"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-8-layer-4"
                                        data-x="['center','center','center','center']"
                                        data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                        data-voffset="['0','0','0','0']" data-fontsize="['36','36','26','20']"
                                        data-lineheight="['40','40','30','26']"
                                        data-letterspacing="['40','40','10','5']"
                                        data-width="['798','798','356','242']" data-height="['42','42','none','none']"
                                        data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                    ...
                                    <a class="tp-caption LA_White_btn rev-btn " href="shop-sidebar.html"
                                        ...
                                        data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                        data-voffset="['286','286','215','164']" data-width="none" data-height="none"
